...
public class Instructions {
    ...
    {
        return all_lengths[instruction_index-1];
    }
    ...
    public double setAllMeters(double Value) { return AllMeters = Value;}
    public double getAllMeters(){ return AllMeters;}
    public LatLng get_LatLng(){
        return all_latlngs[instruction_index];
    }
    public boolean getBoo() {return first;}
    public boolean setBoo() {return first = false;}
